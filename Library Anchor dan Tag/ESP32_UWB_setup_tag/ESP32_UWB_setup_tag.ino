...
void newRange()
{
  ...
  uint16_t distance = (uint16_t)(DW1000Ranging.getDistantDevice()->getRange() * 100.0);

  Serial.write((uint8_t*)&address, sizeof(address));   // kirim 2 byte
  Serial.write((uint8_t*)&distance, sizeof(distance)); // kirim 2 byte
  Serial.write(0xFF);
  Serial.write(0xFF);
}
